	...
	return (
		<div
			...
			<div
				...
				<h5
					id='hexcode'
					class='mb-2 block xl:text-xl font-sans text-lg font-bold text-gray-900 antialiased uppercase'>
					{children}
				</h5>
			</div>
